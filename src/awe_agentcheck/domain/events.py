...
class EventType(str, Enum):
    ...
    PROPOSAL_DISCUSSION_INCOMPLETE = 'proposal_discussion_incomplete'
    ...
    PROPOSAL_REVIEW_CONTRACT_VIOLATION = 'proposal_review_contract_violation'
    ...
    REVIEW_ISSUE_CHECKS = 'review_issue_checks'
